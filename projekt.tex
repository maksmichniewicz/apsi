...
\begin{document}	
	...
	\section{Wstęp}
		...
		bez posiadania efektownych narzędzi wspierajacych proces zarządzania i obsługi
		...
		treści reklamowych i zarządza procesem przetwarzania zebranych zamówień.\\
		...
		ofertowe,
		\item gormadzenie danych o historii transakcji
		\end{itemize}
		...
		chwili może sprawdzić stan i przebieg swojego zamówienia. Z drugiej pozwala
		uniknąć kosztownych wdrożeń i aktualizacji. Aplikacja użytkownika jest
		czytelna i prosta.\\
